...
router.hook('get','/',['admin'],[],function(req,res,role,next){
	...
	fs.readFile(__dirname+'/../views/template_email_seller_paid.jade', 'utf8', function (err,data) {
		if (err) {
			return console.log(err);
		}
		param.saved = data;
		res.render('cms_email_sellerpaid', {param_jade: tools_cms.param_jade(req), title: 'Template Email Seller Dibayar', param:param });
		console.log(data);
	});
});
