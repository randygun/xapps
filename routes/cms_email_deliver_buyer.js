...
router.hook('get','/',['admin'],[],function(req,res,role,next){
	...
	fs.readFile(__dirname+'/../views/template_email_order_deliver_buyer.jade', 'utf8', function (err,data) {
		if (err) {
			return console.log(err);
		}
		param.saved = data;
		res.render('cms_email_deliver_buyer', {param_jade: tools_cms.param_jade(req), title: 'Template Email Order Deliver Buyer', param:param });
		console.log(data);
	});
});
