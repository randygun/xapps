...
router.hook('get','/',['admin'],[],function(req,res,role,next){
	...
	fs.readFile(__dirname+'/../views/template_email_order_agree_seller.jade', 'utf8', function (err,data) {
		if (err) {
			return console.log(err);
		}
		param.saved = data;
		res.render('cms_email_agree_seller', {param_jade: tools_cms.param_jade(req), title: 'Template Email Order Dikonfirmasi Seller', param:param });
		console.log(data);
	});
});
