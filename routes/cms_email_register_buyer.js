...
router.hook('get','/',['admin'],[],function(req,res,role,next){
	...
	fs.readFile(__dirname+'/../views/template_email_register_buyer.jade', 'utf8', function (err,data) {
		if (err) {
			return console.log(err);
		}
		param.saved = data;
		res.render('cms_email_register_buyer', {param_jade: tools_cms.param_jade(req), title: 'Template Email Register Buyer', param:param });
		console.log(data);
	});
});
