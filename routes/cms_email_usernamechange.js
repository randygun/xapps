...
router.hook('get','/',['admin'],[],function(req,res,role,next){
	...
	fs.readFile(__dirname+'/../views/template_email_username_change.jade', 'utf8', function (err,data) {
		if (err) {
			return console.log(err);
		}
		param.saved = data;
		res.render('cms_email_usernamechange', {param_jade: tools_cms.param_jade(req), title: 'Template Email Change Username', param:param });
		console.log(data);
	});
});
